...
This flexdashboard is built from [a Tidy Tuesday dataset contributed by Florent Lavergne](https://github.com/rfordatascience/tidytuesday/blob/master/data/2020/2020-08-18/readme.md). The underlying data comes from the International Union for Conservation (IUCN) Red List. 

On this page, you can explore the global distribution of extinct plants and the correlation of plant extinction, threats to plants, and protective actions taken. (Note that there is no data available for many countries.) In both the figures on this page, you can hover over a plot element for more information. 

On the next page, you can explore the types of threats facing plants, and the actions taken to conserve them, on a per-continent basis.
