...
Inputs {.sidebar}
-------------------------------------------------------------------------------
These tables contain data about **threats facing extinct plants (upper table)** and the **actions taken to protect plants (lower table)** on a per-continent basis. 
