...
Inputs {.sidebar}
-------------------------------------------------------------------------------
These tables contain totals of **threats facing extinct plants (upper table)** and the **actions taken to protect plants (lower table)** on a per-continent basis. 
...
Inputs {.sidebar}
-------------------------------------------------------------------------------
This interactive tree organizes the global list of extinct plants by **location**, **broad evolutionary group**, and **genus**. The levels of the tree are:
...
The size of each node is proportional to the total number of nodes "downstream" from it. (For example, a larger "country" node generally means that relatively more plant species are listed as extinct in that country.)
