...
**On the second tab** (accessible via the top-of-page toolbar), you can explore the types of threats facing plants, and the types of actions taken to conserve them, on a per-continent basis.
